...
const ProductPageOils = ({oils, cart_items, addToCart}) => {
    let {id} = useParams();
    let [item] = oils.filter(item=>item.id == id);
...
export default connect(mapStateToProps, mapDispatchToProps)(ProductPageOils);
