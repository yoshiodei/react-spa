...
const ProductPageSoaps = ({soaps, cart_items, addToCart}) => {
    let {id} = useParams();
    let [item] = soaps.filter(item=>item.id == id);
...
export default connect(mapStateToProps, mapDispatchToProps)(ProductPageSoaps);
